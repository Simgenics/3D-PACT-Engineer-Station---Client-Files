...
namespace ImportExportScene
{
	 ...
	 */
	[Obsolete("Asset bundle and Resources do not go together. We might use resources for something else though.")]
	public class pb_ResourceManager : pb_ScriptableObjectSingleton<pb_ResourceManager>
	{
		...
		public static GameObject LoadPrefabWithMetadata(pb_MetaData metadata)
		{
			...
			switch (metadata.assetType)
			{
				...
				{
					// AssetLoader.LoadAssetFromMetadata used instead of this
					return null;
				}
